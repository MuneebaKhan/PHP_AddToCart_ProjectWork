    ...
    <div class="container"> <br>
        ...
        <form action="ProductCrud.php" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <input type="hidden" name="CatId" value=<?= @$res[
                    'productId'
                ] ?>>
                ...
                <div class="col-sm-12 col-lg-6" style="margin-top:50px;">
                    ...
                    <div class="form-group wrap-input1">
                        ...
                        <select class="form-control wrap-input1" id="cat" name="Category">
                            ...
                            <?php if ($res['Category'] == $data['categoryId']) {
                                echo 'selected';
                ...
                <div class="col-sm-12 col-lg-4 ">
                    ...
                    <div class="d-flex flex-column align-items-center text-center  user-profile-image mt-3">
                        ...
                        <?php } else {echo "<img class='mt-5' style='width:250px;' src='assets/images/noImg.jpg' id='UserImage'>";} ?>
